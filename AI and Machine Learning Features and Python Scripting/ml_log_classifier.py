...
class MLLogClassifier:
    ...
    def batch_predict(self, log_file):
        """Analyze an entire log file with adaptive size handling"""
        ...
        if file_size > 500 * 1024 * 1024:  # > 500MB
            ...
            with open(log_file, 'r', encoding='utf-8', errors='ignore') as f:
                for i, line in enumerate(f, 1):
                    # Sample: first 10k lines + every 100th line after
                    if i < 10000 or (i % 100 == 0):
                        line = line.strip()
                        if not line:
                            continue
                        ...
                        # Flag threats
                        if result['is_threat']:
                            threats_found.append({'line': i, 'threat': line})
