...
class ForensicImageAnalyzer:
    ...
    def calculate_file_hash(self, file_path):
        """Calculate SHA-256 hash for evidence integrity with adaptive sampling for large files"""
        ...
        try:
            ...
            # For very large forensic images, use minimal sampling
